...
export const integrationProjects = pgTable("integration_projects", {
  ...
  status: text("status").notNull().default("draft"), // draft, mapping, ready, deployed
...
export const uploadedFiles = pgTable("uploaded_files", {
  ...
  fileType: text("file_type").notNull(), // csv, json, xml, xlsx
  fileSize: integer("file_size").notNull(),
  systemType: text("system_type").notNull(), // source, target
